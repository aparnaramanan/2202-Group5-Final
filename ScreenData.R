# Emma Wilt - Cleaning and Binning All Screen Data
...
screen1 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen1.csv', sep = ",")
#read in the csv file of screen aware data 2
screen2 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen2.csv', sep = ",")
#read in the csv file of screen aware data 3
screen3 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen3.csv', sep = ",")
#read in the csv file of screen aware data 4
screen4 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen4.csv', sep = ",")
#read in the csv file of screen aware data 5
screen5 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen5.csv', sep = ",")
#read in the csv file of screen aware data 6
screen6 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen6.csv', sep = ",")
#read in the csv file of screen aware data 7
screen7 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen7.csv', sep = ",")
#read in the csv file of screen aware data 8
screen8 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen8.csv', sep = ",")
#read in the csv file of screen aware data 9
screen9 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen9.csv', sep = ",")
#read in the csv file of screen aware data 10
screen10 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen10.csv', sep = ",")
#read in the csv file of screen aware data 11
screen11 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen11.csv', sep = ",")
#read in the csv file of screen aware data 12
screen12 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen12.csv', sep = ",")
#read in the csv file of screen aware data 13
screen13 <- read.csv(file = '/Users/aparnaramanan/Documents/SYS 2202/FinalDataWrangling/Screen/screen13.csv', sep = ",")
...
pre_break_screen <- rbind(pre_break, post_break[which(post_break$date <= "2020-03-06"),])

#remove appropriate rows from post_break df
post_break_screen <- post_break[-which(post_break$date <= ("2020-03-06")),]
